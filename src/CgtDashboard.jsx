...
// UK tax engine (CGT liability, investment-income tax, AEA harvesting
// optimiser) — extracted to a pure, node-tested module (uk-tax.test.mjs).
import {
  cfgFor, aeaForYear, liabilityForYear, liabilityAllYears,
  sharesForTargetGain, investmentIncomeTax, nextTaxYear, optimiseDisposals,
} from "./core/uk-tax.mjs";
// IBKR CSV import (Flex Query + Activity Statement) — extracted to a pure,
// node-tested module (ibkr-import.test.mjs).
import { parseIBKR } from "./core/ibkr-import.mjs";
// iShares "UK Reportable Income" workbook parser — extracted to a pure,
// node-tested module (ishares-eri.test.mjs).
import { parseISharesWorkbook, addMonthsISO } from "./core/ishares-eri.mjs";
